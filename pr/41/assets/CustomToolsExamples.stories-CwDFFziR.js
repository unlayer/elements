import{j as o}from"./jsx-runtime-CYoTa0GU.js";import{R}from"./iframe-IjlVgsC9.js";import{r as V}from"./register-tool-DJdT3ChM.js";import{m as D,a as B,b as F,U as ee,D as J,s as te}from"./create-component-Bh8M9TvS.js";import{B as N,a as O,b as Q,R as h,C as b}from"./Column-dAU5klmh.js";import{E as L}from"./Email-6yOvdBOt.js";import{B as oe}from"./Body-EcYaQyoe.js";import{H as S}from"./Heading-CgfRyEGH.js";import"./preload-helper-PPVm8Dsz.js";function y(e){return o.jsx(oe,{...e,mode:"web"})}y.displayName="Page";y.__docgenInfo={description:`Page - Renders with div/flexbox for responsive web display.
...
\`\`\``,methods:[],displayName:"Page"};function I(e,t,n=0){return{...e,_meta:{htmlID:`u_content_${t.toLowerCase()}_${n+1}`,htmlClassNames:`u_content_${t.toLowerCase()}`,...e._meta||{}}}}function G(e){const t=e.type;return t?.displayName||t?.name}function z(e){const t=[];return R.Children.forEach(e,n=>{R.isValidElement(n)&&t.push(n)}),t}function M(e,t=[]){const n=new Set(["children","mode","className","style","index","colIndex","cells","bodyValues","rowValues","_config","config","previewText","layout","collection",...t]),a={};for(const[i,r]of Object.entries(e))!n.has(i)&&r!==void 0&&(a[i]=r);return a}function H(e,t){return e[t]=(e[t]||0)+1,e[t]}function E(e,t,n,a,i,r,l,s){if(!e)return;const d=[t,n,{displayMode:a,isViewer:!1,variant:null,type:"rows",headConfig:i}],c=e.css?.(...d);c&&r.push(c);const p=e.js?.(...d);p&&l.push(p);const u=e.tags?.(...d);u&&s.push(...u)}function ne(e,t,n,a,i,r,l,s){const c=e.type[ee];if(!c)return;const{name:p,defaultValues:u,propMapper:g}=c,{children:f,...m}=e.props,x=g({children:f,...m}),q=B(u,x),W=c.metaName??p.toLowerCase(),Z=H(i,`u_content_${W}`),K=I(q,W,Z-1),X=c.head??F[p];E(X,K,t,n,a,r,l,s)}function re(e,t,n,a,i,r,l,s,d){const c=M(e.props),p=D(c,Q,"Column"),u=H(r,"u_column"),g=I(B(Q,p),"column",u-1),f=F.Column;E(f,g,t,a,i,l,s,d);const m=z(e.props.children);for(const x of m)ne(x,t,a,i,r,l,s,d)}function ae(e,t,n,a,i,r,l,s){const d=M(e.props,["layout"]),c=D(d,O,"Row"),p=H(i,"u_row"),u=I(B(O,c),"row",p-1),g=F.Row;E(g,u,t,n,a,r,l,s);const f=z(e.props.children);for(const m of f)G(m)==="Column"&&re(m,t,u,n,a,i,r,l,s)}function ie(e,t){const{displayMode:n}=t,a={hasFeature:t.headConfig?.hasFeature??(()=>!1),getInitialValues:t.headConfig?.getInitialValues??(()=>({}))},i=[],r=[],l=[],s={},d=M(e.props),c=D(d,N,"Body"),p=I(B(N,c),"body",0),u=F.Body;E(u,p,p,n,a,i,r,l);const g=z(e.props.children);for(const m of g)G(m)==="Row"&&ae(m,p,n,a,s,i,r,l);const f=[...new Set(l.filter(Boolean))];return{css:i.filter(Boolean).join(`
`),js:r.filter(Boolean).join(`
`),tags:f}}const le={Email:"email",Page:"web",Document:"document"};function de(e,t){const n=e.type?.displayName;return(n?le[n]:void 0)??e.props.mode??t.mode??"web"}function se(e,t){const n={...J,...t};try{const a=R.cloneElement(e,{config:n});return te.renderToStaticMarkup(a)}catch(a){const i=a instanceof Error?a.message:String(a);throw new Error(`[Unlayer] renderToHtml failed: ${i}
Tip: Ensure your tree uses Body > Row > Column > Item structure.`)}}function ce(e,t){const n=se(e,t),a={...J,...t},i=de(e,a),{css:r,js:l,tags:s}=ie(e,{displayMode:i,headConfig:a.headConfig}),d=[];return r&&d.push(`<style>${r}</style>`),l&&d.push(`<script>${l}<\/script>`),s.length>0&&d.push(...s),{head:d.join(`
`),body:n,css:r,js:l,tags:s}}const pe={name:"accordion",options:{menu:{title:"Accordion Items",options:{accordionRow:{label:"Accordion Row",defaultValue:{items:[{title:"How long does shipping take?",description:"Orders ship within 24 hours and arrive in 3–5 business days. Express options are available at checkout."},{title:"What is the return policy?",description:"Everything can come back within 30 days, no questions asked. Returns are free in the continental US."},{title:"Do you offer support?",description:"Real humans answer within a few hours, seven days a week."}]},widget:"accordion_editor"}}},colors:{title:"Colors",options:{titleTextColor:{label:"Title Text Color",defaultValue:"#212121",widget:"color_picker"},descriptionTextColor:{label:"Description Text Color",defaultValue:"#212121",widget:"color_picker"},titleBackgroundColor:{label:"Title Background Color",defaultValue:"#FAFAFA",widget:"color_picker"},descriptionBackgroundColor:{label:"Description Background Color",defaultValue:"#ffffff",widget:"color_picker"},titleHoverBackground:{label:"Title Hover Background Color",defaultValue:"#ECEDEF",widget:"color_picker"}}},fontFamily:{title:"Fonts",options:{fontFamily:{label:"Title Font",defaultValue:{label:"Arial",value:"arial,helvetica,sans-serif"},widget:"font_family"}}}},values:{},renderer:{exporters:{web:e=>{const t=e.accordionRow?.items??[];if(t.length===0)return'<div style="padding:15px;border:2px dashed #ccc;background:#eee;color:#999;text-align:center;">Empty Accordion</div>';const n=t.map(a=>`
          <div>
            <div class="ua-acc-title" onclick="window.__uaAccordionToggle(this)">
              <span>${a.title}</span><span class="ua-acc-icon" style="font-size:20px;">+</span>
            </div>
            <div class="ua-acc-panel"><p style="margin:0;">${a.description}</p></div>
