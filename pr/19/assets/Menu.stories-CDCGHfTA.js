import{j as e}from"./jsx-runtime-h2GonmTe.js";import{c as w,a as S,m as y,E as A,C as n}from"./create-component-DLSQxMKf.js";import{B as f}from"./Body-CsPLd2R6.js";import{R as t,C as a}from"./Column-CTyJs9dm.js";import{H as u}from"./Heading-kQf8Ac9k.js";import{P as o}from"./Paragraph-BIrbvz5P.js";import{U as x}from"./UnlayerProvider-Cli3M4yY.js";import"./iframe-CqXV12QK.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),W={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
