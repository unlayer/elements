import{j as e}from"./jsx-runtime-CuA_b3OC.js";import{c as w,a as S,m as y,E as A,C as n}from"./create-component-DB2Z4bDD.js";import{B as f}from"./Body-CCYLmv6m.js";import{R as t,C as a}from"./Column-6dNojORm.js";import{H as u}from"./Heading-_53h_WJ5.js";import{P as o}from"./Paragraph-Bwpmu13O.js";import{U as x}from"./UnlayerProvider-DAMxfx-b.js";import"./iframe-BSVQ9d6x.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),W={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
