import{j as e}from"./jsx-runtime-CQbKZvFY.js";import{c as w,b as S,m as y,G as A,C as n}from"./create-component-BfIsZgQA.js";import{B as f}from"./Body-3uRaLVsr.js";import{R as t,C as a}from"./Column-dnyuzb_Q.js";import{H as u}from"./Heading-Ccy_Rn-i.js";import{P as o}from"./Paragraph-C_KDl7nt.js";import{U as x}from"./UnlayerProvider-D16krczz.js";import"./iframe-OeZ8g3bd.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),W={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
