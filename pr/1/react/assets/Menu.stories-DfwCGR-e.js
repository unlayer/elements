import{j as e}from"./jsx-runtime-BmHDSO9P.js";import{c as w,m as y,t as S,C as n}from"./index-BdhjsKVo.js";import{B as f}from"./Body-DALDClxX.js";import{R as t,C as a}from"./Column-DLvNBP9d.js";import{H as u}from"./Heading-Bhi-wadU.js";import{P as o}from"./Paragraph-CiaCcoNK.js";import{U as x}from"./UnlayerProvider-tKaYRlAe.js";import"./iframe-Bl8K1Mum.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},m={align:"center",menu:A,layout:"horizontal",separator:"|"},p=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:S}),M={title:"Components/Menu",component:p,parameters:{layout:"centered",docs:{description:{component:`
