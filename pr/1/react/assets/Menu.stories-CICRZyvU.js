import{j as e}from"./jsx-runtime-BoPZWCff.js";import{c as w,I as S,m as y,X as A,C as n}from"./create-component-BUbDG9rC.js";import{B as f}from"./Body-b1yb29l4.js";import{R as t,C as a}from"./Column--vWIyY8i.js";import{H as u}from"./Heading-mAr0YbuJ.js";import{P as o}from"./Paragraph-EsixAkE8.js";import{U as x}from"./UnlayerProvider-C2o6EBjG.js";import"./iframe-G93jp_vW.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),W={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
