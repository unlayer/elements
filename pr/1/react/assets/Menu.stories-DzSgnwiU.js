import{j as n}from"./jsx-runtime-Bn0AtHW-.js";import{c as w,Y as S,m as y,C as e}from"./create-component-5DT4zA3W.js";import{B as f}from"./Body-PGkCgqzT.js";import{R as t,C as a}from"./Column-CN30VeD5.js";import{H as m}from"./Heading-DmDNSTNn.js";import{P as o}from"./Paragraph-ek15swxO.js";import{U as x}from"./UnlayerProvider-Exh_Wa2B.js";import"./iframe-BItrZ_kU.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:g=>{const{items:h,...v}=g;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(g,u,"Menu")},displayName:"Menu",exporters:S}),U={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
