import{j as n}from"./jsx-runtime-DVhZnXbq.js";import{c as w,Y as S,m as y,C as e}from"./create-component-9B4R7L_G.js";import{B as f}from"./Body-CWPJQPE3.js";import{R as t,C as a}from"./Column-C5e9aChF.js";import{H as m}from"./Heading-CCu5shO0.js";import{P as o}from"./Paragraph-KnyPt2UH.js";import{U as x}from"./UnlayerProvider-CorF2PAX.js";import"./iframe-CaJBm43p.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:g=>{const{items:h,...v}=g;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(g,u,"Menu")},displayName:"Menu",exporters:S}),U={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
