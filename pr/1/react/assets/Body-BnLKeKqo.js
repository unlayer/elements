import{j as m}from"./jsx-runtime-Kasi1d3_.js";import{R as t}from"./iframe-DEDLJ5Qq.js";import{D as x,m as S,R as P,a as T}from"./create-component-DFxexp61.js";const b={_meta:{},backgroundColor:"#F7F8F9",backgroundImage:{url:"",fullWidth:!0,repeat:"no-repeat",size:"custom",position:"center"},contentAlign:"center",contentWidth:"500px",fontFamily:{label:"Arial",value:"arial,helvetica,sans-serif"},linkStyle:{body:!0,linkColor:"#0000ee",linkHoverColor:"#0000ee",linkUnderline:!0,linkHoverUnderline:!0},textColor:"#000000"},c=p=>{const{children:n,mode:y,className:i,style:a,index:u=0,config:f,previewText:C,...g}=p,s={...x,...f},l=y??s.mode??"web",v={...s,mode:l},d=S(g,b,"Body"),h={...d,_meta:{htmlID:`u_body_${u+1}`,htmlClassNames:"u_body",...d._meta||{}}};let o=n;n&&(o=t.Children.map(n,e=>t.isValidElement(e)?t.cloneElement(e,{_config:v}):e));let r="";if(o)try{r=P.renderToString(o)}catch(e){console.error("Body: Failed to render children:",e),r=""}try{const e=T({innerHTML:r,values:h,mode:l,previewText:C});return m.jsx("div",{dangerouslySetInnerHTML:{__html:e},className:i,style:a})}catch(e){return console.error("Body rendering failed:",e),m.jsx("div",{className:i,style:a,children:n})}};c.displayName="Body";c.__docgenInfo={description:`Body - Universal Server/Client Component
