import{j as e}from"./jsx-runtime-CF8rk6vc.js";import{c as y,w as x,m as f,C as r}from"./create-component-BZmYVuXU.js";import{B as v}from"./Body-BMsH75LE.js";import{R as i,C as s}from"./Column-B2im8jMj.js";import{H as C}from"./Heading-CcOfAccu.js";import{T as p}from"./Text-DEV7BMHn.js";import{B as A}from"./Button-tToB_epz.js";import{U as Q}from"./UnlayerProvider-C3rROvxF.js";import"./iframe-sVg1NmRN.js";import"./preload-helper-PPVm8Dsz.js";const w={type:"youtube",videoId:"",thumbnail:"",loading:!1},h={video:w};function j(n){const t=n.match(/(?:youtube\.com\/(?:watch\?v=|embed\/)|youtu\.be\/)([a-zA-Z0-9_-]{11})/);if(t){const o=t[1];return{type:"youtube",videoId:o,thumbnail:`https://img.youtube.com/vi/${o}/0.jpg`}}const a=n.match(/vimeo\.com\/(\d+)/);return a?{type:"vimeo",videoId:a[1],thumbnail:""}:null}const b=y({name:"Video",defaultValues:h,propMapper:n=>{const{videoUrl:t,...a}=n;if(typeof t=="string"){const o=j(t),g=f(a,h,"Video");return o&&(g.video={...w,...o}),g}return f(n,h,"Video")},displayName:"Video",exporters:x}),U={title:"Components/Video",component:b,parameters:{layout:"centered",docs:{description:{component:"Embeds video players with thumbnail fallbacks for email compatibility. Supports YouTube and Vimeo sources with responsive sizing. In email mode, renders a clickable thumbnail image instead of an iframe."}}},argTypes:{values:{description:"Video configuration including source URL, thumbnail, and player type.",control:!1,table:{type:{summary:"VideoValues",detail:`{
  video: {
    type: "youtube" | "vimeo";
    videoId: string;
    url: string;
