import{j as n}from"./jsx-runtime-gAUb4kTp.js";import{c as w,O as S,m as y}from"./create-component-CvOey92g.js";import{U as f,B as x}from"./Body-CqM-cZQP.js";import{R as e,C as t,a}from"./Column-DDmaGOUc.js";import{H as m}from"./Heading-BNPAxUk3.js";import{T as o}from"./Text-Dz9iJLcN.js";import"./iframe-DL3u3kGV.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:g=>{const{items:h,...v}=g;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(g,u,"Menu")},displayName:"Menu",exporters:S}),I={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
# Menu Component
