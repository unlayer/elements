import{j as e}from"./jsx-runtime-QZhfyhdM.js";import{c as w,b as S,m as y,G as A,C as n}from"./create-component-Dy-zN2hY.js";import{B as f}from"./Body-BAFBnv6S.js";import{R as t,C as a}from"./Column-DhQ2jODN.js";import{H as u}from"./Heading-BZqnvsA4.js";import{P as o}from"./Paragraph-ohAlrTep.js";import{U as x}from"./UnlayerProvider-ByY8tx9M.js";import"./iframe-BtvyOEmj.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),W={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
