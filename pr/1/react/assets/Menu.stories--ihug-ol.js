import{j as n}from"./jsx-runtime-1ADhLvOJ.js";import{c as w,O as S,m as y}from"./create-component-Bfb7Op8G.js";import{U as f,B as x}from"./Body-C2wRjN5C.js";import{R as e,C as t,a}from"./Column-Cv3mVIAw.js";import{H as m}from"./Heading-BVa0Qc-U.js";import{T as o}from"./Text-DHzXOpSu.js";import"./iframe-5pqsCEzN.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:g=>{const{items:h,...v}=g;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(g,u,"Menu")},displayName:"Menu",exporters:S}),I={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
# Menu Component
