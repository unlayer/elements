import{j as e}from"./jsx-runtime-Kasi1d3_.js";import{c as x,m as c,G as f}from"./create-component-DFxexp61.js";import"./iframe-DEDLJ5Qq.js";import"./preload-helper-PPVm8Dsz.js";const p={html:"<p>Custom HTML content</p>"},t=x({name:"Html",defaultValues:p,propMapper:g=>c(g,p,"Html"),displayName:"Html",exporters:f}),y={title:"Components/Html",component:t,parameters:{layout:"centered",docs:{description:{component:`
...
- Advanced content blocks
        `}}},argTypes:{mode:{control:{type:"select"},options:["web","email","document"],description:"**Rendering Mode** - Controls output format and html optimizations",table:{defaultValue:{summary:"web"},type:{summary:"RenderMode"}}}},tags:["autodocs"]},i={args:{mode:"web"}},n={args:{html:`
        <div style="
      ...
      `,mode:"email"}},l={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"40px",padding:"20px",background:"#f8fafc"},children:[e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Custom Styled Card"}),e.jsx(t,{html:`
              <div style="
                background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            ...
            `,mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Progress Indicators"}),e.jsx(t,{html:`
            ...
            `,mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Statistics Grid"}),e.jsx(t,{html:`
            ...
            `,mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Testimonial"}),e.jsx(t,{html:`
            ...
            `,mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Email-Safe HTML"}),e.jsx("div",{style:{backgroundColor:"#ffffff",padding:"20px",borderRadius:"8px"},children:e.jsx(t,{html:`
              ...
              `,mode:"email"})})]})]})};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    mode: "web"
  }
...
}`,...l.parameters?.docs?.source}}};const v=["Default","StyledCard","ProgressBars","CallToAction","TestimonialCard","Statistics","EmailHtml","HtmlShowcase"];export{r as CallToAction,i as Default,s as EmailHtml,l as HtmlShowcase,o as ProgressBars,d as Statistics,n as StyledCard,a as TestimonialCard,v as __namedExportsOrder,y as default};
