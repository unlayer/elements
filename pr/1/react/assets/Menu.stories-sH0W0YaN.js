import{j as e}from"./jsx-runtime-DWFSp5On.js";import{c as w,m as y,X as S,C as n}from"./create-component-Cta9Y68f.js";import{B as f}from"./Body-B8SQv6vT.js";import{R as t,C as a}from"./Column-ChvVhDNa.js";import{H as u}from"./Heading-DLpxbOfi.js";import{P as o}from"./Paragraph-C1cgTa9W.js";import{U as x}from"./UnlayerProvider-6WfzyqOb.js";import"./iframe-G32c0iJ5.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},m={align:"center",menu:A,layout:"horizontal",separator:"|"},p=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:S}),M={title:"Components/Menu",component:p,parameters:{layout:"centered",docs:{description:{component:`
