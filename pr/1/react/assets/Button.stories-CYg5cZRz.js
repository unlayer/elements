import{j as o}from"./jsx-runtime-aAGwtYT1.js";import{B as n}from"./Button-BBHdbZt2.js";import"./iframe-BuDeX7mP.js";import"./preload-helper-PPVm8Dsz.js";import"./create-component-BLckUOSM.js";const x={title:"Components/Button",component:n,parameters:{layout:"centered",docs:{description:{component:`
# 🎯 Button Component
...
Pass your button text as children and use semantic props for styling!
        `}}},argTypes:{children:{description:"**Button Text** - The text to display on the button",control:"text",table:{type:{summary:"string | ReactNode"}}},backgroundColor:{description:"**Background Color** - Button background color",control:"color"},color:{description:"**Text Color** - Button text color",control:"color"},hoverBackgroundColor:{description:"**Hover Background** - Background color on hover",control:"color"},hoverColor:{description:"**Hover Text Color** - Text color on hover",control:"color"},padding:{description:"**Padding** - Internal spacing (e.g., '12px 24px')",control:"text"},borderRadius:{description:"**Border Radius** - Corner rounding (e.g., '8px')",control:"text"},fontSize:{description:"**Font Size** - Text size (e.g., '16px')",control:"text"},fontWeight:{description:"**Font Weight** - Text weight (e.g., '600')",control:"text"},href:{description:"**Link** - URL or link configuration",control:"text"},mode:{control:{type:"select"},options:["web","email","document"],description:"**Rendering Mode** - Controls output format and optimizations",table:{defaultValue:{summary:"web"},type:{summary:"RenderMode"}}}},tags:["autodocs"]},e={render:()=>o.jsx(n,{children:"Click Me"}),parameters:{docs:{description:{story:`
...
**✨ Automatic mapping:** \`backgroundColor\`, \`color\`, \`hoverBackgroundColor\`, and \`hoverColor\` are automatically grouped into the \`buttonColors\` object!
        `}}}},i={render:()=>o.jsx(n,{backgroundColor:"#10b981",color:"white",hoverBackgroundColor:"#059669",padding:"16px 32px",borderRadius:"12px",fontSize:"18px",fontWeight:"600",width:"100%",autoWidth:!1,children:"Tap to Continue"}),parameters:{docs:{description:{story:`
...
\`\`\`
        `}}}},d={render:()=>o.jsx(n,{backgroundColor:"#7c3aed",color:"white",hoverBackgroundColor:"#6d28d9",padding:"14px 24px",borderRadius:"6px",fontSize:"16px",fontWeight:"500",mode:"email",children:"View in Browser"}),parameters:{docs:{description:{story:`
**📧 Email-Safe Button**
...
Uses conservative styling that renders consistently across all email platforms.
        `}}}},a={parameters:{docs:{description:{story:"**Complete Button Gallery** - Showcase of various button styles and use cases using semantic props. All examples use the clean, React-friendly API."}}},render:()=>o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"32px",padding:"20px",background:"#f8fafc"},children:[o.jsxs("div",{children:[o.jsx("h3",{style:{margin:"0 0 16px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"🎯 Call-to-Action Buttons"}),o.jsxs("div",{style:{display:"flex",gap:"16px",flexWrap:"wrap"},children:[o.jsx(n,{backgroundColor:"#2563eb",color:"white",hoverBackgroundColor:"#1d4ed8",padding:"14px 28px",borderRadius:"8px",fontSize:"16px",fontWeight:"600",children:"Get Started Free"}),o.jsx(n,{backgroundColor:"#059669",color:"white",hoverBackgroundColor:"#047857",padding:"14px 28px",borderRadius:"8px",fontSize:"16px",fontWeight:"600",children:"Start Free Trial"}),o.jsx(n,{backgroundColor:"#7c3aed",color:"white",hoverBackgroundColor:"#6d28d9",padding:"14px 28px",borderRadius:"8px",fontSize:"16px",fontWeight:"600",children:"Join Premium"})]})]}),o.jsxs("div",{children:[o.jsx("h3",{style:{margin:"0 0 16px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"🌟 Secondary Actions"}),o.jsxs("div",{style:{display:"flex",gap:"16px",flexWrap:"wrap"},children:[o.jsx(n,{backgroundColor:"transparent",color:"#2563eb",hoverBackgroundColor:"#2563eb",hoverColor:"white",borderWidth:"2px",borderStyle:"solid",borderColor:"#2563eb",padding:"12px 24px",borderRadius:"8px",fontSize:"16px",children:"Learn More"}),o.jsx(n,{backgroundColor:"#f9fafb",color:"#6b7280",hoverBackgroundColor:"#f3f4f6",hoverColor:"#374151",borderWidth:"1px",borderStyle:"solid",borderColor:"#d1d5db",padding:"12px 24px",borderRadius:"8px",fontSize:"16px",children:"Watch Demo"})]})]}),o.jsxs("div",{children:[o.jsx("h3",{style:{margin:"0 0 16px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"🎨 Creative Styles"}),o.jsxs("div",{style:{display:"flex",gap:"16px",flexWrap:"wrap",alignItems:"center"},children:[o.jsx(n,{backgroundColor:"#8b5cf6",color:"white",hoverBackgroundColor:"#7c3aed",padding:"16px 32px",borderRadius:"16px",fontSize:"16px",fontWeight:"700",children:"Gradient Magic"}),o.jsx(n,{backgroundColor:"#f59e0b",color:"white",hoverBackgroundColor:"#d97706",padding:"12px 28px",borderRadius:"50px",fontSize:"16px",fontWeight:"600",children:"Rounded Pill"}),o.jsx(n,{backgroundColor:"#ef4444",color:"white",hoverBackgroundColor:"#dc2626",padding:"12px 24px",borderRadius:"0px",fontSize:"16px",fontWeight:"600",children:"Sharp Edge"})]})]}),o.jsxs("div",{children:[o.jsx("h3",{style:{margin:"0 0 16px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"📧 Email-Safe Buttons"}),o.jsxs("div",{style:{display:"flex",gap:"16px",flexWrap:"wrap"},children:[o.jsx(n,{backgroundColor:"#3b82f6",color:"white",padding:"14px 24px",borderRadius:"6px",fontSize:"16px",mode:"email",children:"View Email"}),o.jsx(n,{backgroundColor:"white",color:"#6b7280",hoverBackgroundColor:"#f9fafb",borderWidth:"1px",borderStyle:"solid",borderColor:"#d1d5db",padding:"10px 20px",borderRadius:"4px",fontSize:"14px",mode:"email",children:"Unsubscribe"})]})]})]})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
...
}`,...a.parameters?.docs?.source}}};const g=["SimpleButton","WithSemanticProps","WithLinkAndHover","MobileButton","EmailSafeButton","ButtonShowcase"];export{a as ButtonShowcase,d as EmailSafeButton,i as MobileButton,e as SimpleButton,t as WithLinkAndHover,r as WithSemanticProps,g as __namedExportsOrder,x as default};
