import{j as e}from"./jsx-runtime-DVhZnXbq.js";import{c as y,w as x,m as f,C as r}from"./create-component-9B4R7L_G.js";import{B as v}from"./Body-CWPJQPE3.js";import{R as i,C as s}from"./Column-C5e9aChF.js";import{H as C}from"./Heading-CCu5shO0.js";import{P as p}from"./Paragraph-KnyPt2UH.js";import{B as A}from"./Button-C1KUfWi1.js";import{U as P}from"./UnlayerProvider-CorF2PAX.js";import"./iframe-CaJBm43p.js";import"./preload-helper-PPVm8Dsz.js";const w={type:"youtube",videoId:"",thumbnail:"",loading:!1},h={video:w};function Q(n){const t=n.match(/(?:youtube\.com\/(?:watch\?v=|embed\/)|youtu\.be\/)([a-zA-Z0-9_-]{11})/);if(t){const o=t[1];return{type:"youtube",videoId:o,thumbnail:`https://img.youtube.com/vi/${o}/0.jpg`}}const a=n.match(/vimeo\.com\/(\d+)/);return a?{type:"vimeo",videoId:a[1],thumbnail:""}:null}const b=y({name:"Video",defaultValues:h,propMapper:n=>{const{videoUrl:t,...a}=n;if(typeof t=="string"){const o=Q(t),g=f(a,h,"Video");return o&&(g.video={...w,...o}),g}return f(n,h,"Video")},displayName:"Video",exporters:x}),U={title:"Components/Video",component:b,parameters:{layout:"centered",docs:{description:{component:"Embeds video players with thumbnail fallbacks for email compatibility. Supports YouTube and Vimeo sources with responsive sizing. In email mode, renders a clickable thumbnail image instead of an iframe."}}},argTypes:{values:{description:"Video configuration including source URL, thumbnail, and player type.",control:!1,table:{type:{summary:"VideoValues",detail:`{
  video: {
    type: "youtube" | "vimeo";
    videoId: string;
    url: string;
...
}`,...m.parameters?.docs?.source}}};const z=["Default","FullValuesAPI","ProductDemo","YouTubeEmbed","EmailVideo"];export{d as Default,m as EmailVideo,l as FullValuesAPI,c as ProductDemo,u as YouTubeEmbed,z as __namedExportsOrder,U as default};
