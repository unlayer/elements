import{j as n}from"./jsx-runtime-CSQpYQ-p.js";import{c as w,Y as S,m as y,C as e}from"./create-component-wX7Ip7wH.js";import{B as f}from"./Body-DbDwEZp1.js";import{R as t,C as a}from"./Column-elImdKqR.js";import{H as m}from"./Heading-CWkh9QKq.js";import{T as o}from"./Text-qsx1h78Y.js";import{U as x}from"./UnlayerProvider-DEh761y-.js";import"./iframe-BeiplXWw.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:g=>{const{items:h,...v}=g;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(g,u,"Menu")},displayName:"Menu",exporters:S}),U={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
# Menu Component
