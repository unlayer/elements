import{j as e}from"./jsx-runtime-CYqTBfGC.js";import{T as t}from"./Text-D9PfSsDM.js";import"./iframe-qpO4ClsL.js";import"./preload-helper-PPVm8Dsz.js";import"./create-component-DkDOQJwJ.js";const S={title:"Components/Text",component:t,parameters:{layout:"centered",docs:{description:{component:`
# 📝 Text Component
...
- When you want default styling
        `}}}},o={render:()=>e.jsx(t,{color:"#374151",fontSize:"16px",lineHeight:"1.6",fontWeight:"500",textAlign:"center",containerPadding:"20px",children:"This text uses semantic props for styling! It's centered with custom colors, sizing, and spacing."}),parameters:{docs:{description:{story:`
...
- \\\`containerPadding\\\`: Padding around text
  ...
  render: () => <Text color="#374151" fontSize="16px" lineHeight="1.6">
      {\`Visit our <a href="https://example.com" style="color: #2563eb; text-decoration: underline;">website</a> for more info, or <a href="mailto:hello@example.com" style="color: #2563eb; text-decoration: underline;">email us</a> directly.\`}
    </Text>,
  parameters: {
    docs: {
      description: {
...
This works because the Text component renders HTML content as-is.
  ...
  render: () => <Text color="#333333" fontSize="16px" lineHeight="1.5" mode="email">
      {\`Thanks for subscribing! <a href="https://example.com/prefs" style="color: #2563eb; text-decoration: underline;">Manage preferences</a> or <a href="https://example.com/unsub" style="color: #6b7280; text-decoration: underline;">unsubscribe</a>.\`}
    </Text>,
  parameters: {
    docs: {
      description: {
...
}`,...f.parameters?.docs?.source}}};const v=["SimpleText","WithSemanticProps","Default","BodyText","CaptionText","HighlightedText","LinkedText","ProfessionalText","MobileText","EmailText","ColorfulText","WithInlineLinks","WithInlineLinksEmail","TextShowcase"];export{r as BodyText,s as CaptionText,x as ColorfulText,i as Default,p as EmailText,a as HighlightedText,l as LinkedText,d as MobileText,c as ProfessionalText,n as SimpleText,f as TextShowcase,m as WithInlineLinks,g as WithInlineLinksEmail,o as WithSemanticProps,v as __namedExportsOrder,S as default};
