import{j as n}from"./jsx-runtime-aAGwtYT1.js";import{c as w,O as S,m as y}from"./create-component-BLckUOSM.js";import{U as f,B as x}from"./Body-736sxM9x.js";import{R as e,C as t,a}from"./Column-CdTcs2yN.js";import{H as m}from"./Heading-jhDfz08L.js";import{T as o}from"./Text-DpLvttFf.js";import"./iframe-BuDeX7mP.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:g=>{const{items:h,...v}=g;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(g,u,"Menu")},displayName:"Menu",exporters:S}),I={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
# Menu Component
