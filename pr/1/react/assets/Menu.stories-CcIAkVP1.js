import{j as n}from"./jsx-runtime-CYqTBfGC.js";import{c as w,Y as S,m as y,C as e}from"./create-component-DkDOQJwJ.js";import{B as f}from"./Body-Cjyp3AhQ.js";import{R as t,C as a}from"./Column-ClZo-hA0.js";import{H as m}from"./Heading-r7x_IOTA.js";import{T as o}from"./Text-D9PfSsDM.js";import{U as x}from"./UnlayerProvider-aqF3DQZf.js";import"./iframe-qpO4ClsL.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:g=>{const{items:h,...v}=g;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(g,u,"Menu")},displayName:"Menu",exporters:S}),U={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
# Menu Component
