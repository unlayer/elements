import{j as n}from"./jsx-runtime-CMO6xtnS.js";import{c as w,Y as S,m as y}from"./create-component-BRRZvuvv.js";import{U as f,B as x}from"./Body-BgAm0RmZ.js";import{R as e,C as t,a}from"./Column-Qfs16YQj.js";import{H as m}from"./Heading-CauWNbHv.js";import{T as o}from"./Text-BjeBawy_.js";import"./iframe-C1UADmNS.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:g=>{const{items:h,...v}=g;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(g,u,"Menu")},displayName:"Menu",exporters:S}),I={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
# Menu Component
