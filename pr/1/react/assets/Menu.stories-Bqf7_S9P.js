import{j as e}from"./jsx-runtime-Kasi1d3_.js";import{c as w,m as y,X as S,C as n}from"./create-component-DFxexp61.js";import{B as f}from"./Body-BnLKeKqo.js";import{R as t,C as a}from"./Column-CnYkoSRw.js";import{H as u}from"./Heading-CpfOMgyT.js";import{P as o}from"./Paragraph-DOQ7-ynV.js";import{U as x}from"./UnlayerProvider-CQ66S4EM.js";import"./iframe-DEDLJ5Qq.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},m={align:"center",menu:A,layout:"horizontal",separator:"|"},p=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:S}),M={title:"Components/Menu",component:p,parameters:{layout:"centered",docs:{description:{component:`
...
}`,...c.parameters?.docs?.source}}};const W=["Default","FullPropsAPI","EmailHeader","FooterLinks","StyledNavigation"];export{r as Default,l as EmailHeader,s as FooterLinks,i as FullPropsAPI,c as StyledNavigation,W as __namedExportsOrder,M as default};
