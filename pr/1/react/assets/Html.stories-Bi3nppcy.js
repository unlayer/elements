import{j as e}from"./jsx-runtime-1ADhLvOJ.js";import{c,H as x,m as f}from"./create-component-Bfb7Op8G.js";import"./iframe-5pqsCEzN.js";import"./preload-helper-PPVm8Dsz.js";const p={html:"<p>Custom HTML content</p>"},t=c({name:"Html",defaultValues:p,propMapper:g=>f(g,p,"Html"),displayName:"Html",exporters:x}),v={title:"Components/Html",component:t,parameters:{layout:"centered",docs:{description:{component:`
# 🔧 Html Component
...
- 🛡️ **Safe Rendering**: Sanitized HTML output
...
- Advanced content blocks
        `}}},argTypes:{values:{description:"**Html Configuration Object**\n\nMain html options:\n- `html`: Raw HTML content\n- `sanitize`: HTML sanitization options\n- `styles`: Custom CSS styling\n- `responsive`: Mobile optimization settings\n\n*See individual stories below for complete examples*",control:!1,table:{type:{summary:"HtmlValues",detail:`{
  // Html-specific properties
  // See component schema for full options
}`}}},mode:{control:{type:"select"},options:["web","email","document"],description:"**Rendering Mode** - Controls output format and html optimizations",table:{defaultValue:{summary:"web"},type:{summary:"RenderMode"}}}},tags:["autodocs"]},n={args:{mode:"web"}},i={args:{values:{html:`
        <div style="
      ...
      `},mode:"email"}},l={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"40px",padding:"20px",background:"#f8fafc"},children:[e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"🎨 Custom Styled Card"}),e.jsx(t,{values:{html:`
              <div style="
                background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            ...
            `},mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"📊 Progress Indicators"}),e.jsx(t,{values:{html:`
            ...
            `},mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"🌟 Statistics Grid"}),e.jsx(t,{values:{html:`
            ...
            `},mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"📝 Testimonial"}),e.jsx(t,{values:{html:`
            ...
            `},mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"📧 Email-Safe HTML"}),e.jsx("div",{style:{backgroundColor:"#ffffff",padding:"20px",borderRadius:"8px"},children:e.jsx(t,{values:{html:`
              ...
              `},mode:"email"})})]})]})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
    mode: "web"
  }
...
}`,...l.parameters?.docs?.source}}};const y=["Default","StyledCard","ProgressBars","CallToAction","TestimonialCard","Statistics","EmailHtml","HtmlShowcase"];export{r as CallToAction,n as Default,s as EmailHtml,l as HtmlShowcase,o as ProgressBars,d as Statistics,i as StyledCard,a as TestimonialCard,y as __namedExportsOrder,v as default};
