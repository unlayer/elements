import{j as e}from"./jsx-runtime-fvgVF0Ya.js";import{c as w,m as y,Y as S,C as n}from"./create-component--L6scIHr.js";import{B as f}from"./Body-kZCgo_ma.js";import{R as t,C as a}from"./Column-C9tsKC4G.js";import{H as u}from"./Heading-BehCHiCc.js";import{P as o}from"./Paragraph-DtCYVjX0.js";import{U as x}from"./UnlayerProvider-CJObAvG3.js";import"./iframe-CCZdLbOt.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},m={align:"center",menu:A,layout:"horizontal",separator:"|"},p=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:S}),M={title:"Components/Menu",component:p,parameters:{layout:"centered",docs:{description:{component:`
