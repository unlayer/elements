import{j as n}from"./jsx-runtime-CeNQlCuc.js";import{c as w,O as S,m as y}from"./create-component-DEvu5BmU.js";import{U as f,B as x}from"./Body-BcFaf7ar.js";import{R as e,a as t,C as a}from"./Column-DBOgK1Qy.js";import{H as m}from"./Heading-DSUodn_3.js";import{T as o}from"./Text-DZoIEdgn.js";import"./iframe-Ofo6XfC9.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:g=>{const{items:h,...v}=g;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(g,u,"Menu")},displayName:"Menu",exporters:S}),I={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
# Menu Component
...
\`\`\`
        `}}}},s={render:()=>n.jsx(f,{config:{mode:"email"},children:n.jsxs(x,{backgroundColor:"#f9fafb",contentAlign:"center",contentWidth:"600px",fontFamily:{label:"Arial",value:"Arial, Helvetica, sans-serif"},textColor:"#6b7280",children:[n.jsx(e,{layout:t.OneColumn,backgroundColor:"#e5e7eb",padding:"0px",children:n.jsx(a,{padding:"1px",children:n.jsx(o,{values:{text:"&nbsp;",fontSize:"1px",lineHeight:"1px",containerPadding:"0"}})})}),n.jsx(e,{layout:t.OneColumn,backgroundColor:"#f9fafb",padding:"28px 24px 12px 24px",children:n.jsx(a,{children:n.jsx(o,{values:{text:"Acme Inc. | 123 Main Street, San Francisco, CA 94105",fontSize:"12px",color:"#9ca3af",textAlign:"center",lineHeight:"150%",fontFamily:"Arial, Helvetica, sans-serif",containerPadding:"0 0 12px 0"}})})}),n.jsx(e,{layout:t.OneColumn,backgroundColor:"#f9fafb",padding:"0px 24px 28px 24px",children:n.jsx(a,{children:n.jsx(c,{values:{menu:{items:[{text:"View Online",link:{name:"web",values:{href:"https://example.com/view",target:"_blank"}}},{text:"Unsubscribe",link:{name:"web",values:{href:"https://example.com/unsubscribe",target:"_blank"}}},{text:"Privacy Policy",link:{name:"web",values:{href:"https://example.com/privacy",target:"_blank"}}},{text:"Terms",link:{name:"web",values:{href:"https://example.com/terms",target:"_blank"}}}]},layout:"horizontal",align:"center",separator:"-",padding:"6px 10px",fontSize:"12px",fontWeight:"normal",linkColor:"#6b7280",textColor:"#d1d5db",letterSpacing:"0px",fontFamily:{label:"Arial",value:"Arial, Helvetica, sans-serif"},containerPadding:"0"}})})})]})}),parameters:{layout:"fullscreen",docs:{description:{story:`
**Email Footer Links**
...
/>
\`\`\`
        `}}}},p={render:()=>n.jsx(f,{config:{mode:"web"},children:n.jsxs(x,{backgroundColor:"#0f172a",contentAlign:"center",contentWidth:"800px",fontFamily:{label:"Inter",value:"Inter, system-ui, -apple-system, sans-serif"},textColor:"#ffffff",children:[n.jsx(e,{layout:t.OneColumn,backgroundColor:"#1e293b",padding:"20px 32px",children:n.jsx(a,{children:n.jsx(c,{values:{menu:{items:[{text:"DASHBOARD",link:{name:"web",values:{href:"/dashboard",target:"_self"}}},{text:"ANALYTICS",link:{name:"web",values:{href:"/analytics",target:"_self"}}},{text:"TEMPLATES",link:{name:"web",values:{href:"/templates",target:"_self"}}},{text:"INTEGRATIONS",link:{name:"web",values:{href:"/integrations",target:"_self"}}},{text:"SETTINGS",link:{name:"web",values:{href:"/settings",target:"_self"}}}]},layout:"horizontal",align:"center",separator:"",padding:"10px 20px",fontSize:"12px",fontWeight:"700",linkColor:"#94a3b8",textColor:"#475569",letterSpacing:"1.5px",fontFamily:{label:"Inter",value:"Inter, system-ui, -apple-system, sans-serif"},containerPadding:"0"}})})}),n.jsx(e,{layout:t.OneColumn,backgroundColor:"#0f172a",padding:"64px 40px 48px 40px",children:n.jsxs(a,{children:[n.jsx(m,{values:{text:"Ship faster with Unlayer",headingType:"h1",fontSize:"44px",fontWeight:"800",color:"#f8fafc",textAlign:"center",fontFamily:"Inter, system-ui, sans-serif",lineHeight:"110%",containerPadding:"0 0 20px 0"}}),n.jsx(o,{values:{text:"Drag-and-drop email and page builders you can embed in your SaaS in minutes, not months.",fontSize:"18px",color:"#94a3b8",textAlign:"center",lineHeight:"160%",fontFamily:"Inter, system-ui, sans-serif",containerPadding:"0"}})]})})]})}),parameters:{layout:"fullscreen",docs:{description:{story:`
...
}`,...p.parameters?.docs?.source}}};const U=["Default","FullValuesAPI","EmailHeader","FooterLinks","StyledNavigation"];export{r as Default,l as EmailHeader,s as FooterLinks,i as FullValuesAPI,p as StyledNavigation,U as __namedExportsOrder,I as default};
