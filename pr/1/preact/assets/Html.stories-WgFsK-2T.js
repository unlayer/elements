import{u as e}from"./compat.module-fI-V5Ght.js";import{c,J as x,m as f}from"./create-component-BWEBAc00.js";import"./iframe-BgLncab-.js";import"./preload-helper-PPVm8Dsz.js";const p={html:"<p>Custom HTML content</p>"},t=c({name:"Html",defaultValues:p,propMapper:g=>f(g,p,"Html"),displayName:"Html",exporters:x}),v={title:"Components/Html",component:t,parameters:{layout:"centered",docs:{description:{component:`
# 🔧 Html Component
...
- Advanced content blocks
  ...
  // See component schema for full options
      ...
      `},mode:"email"}},l={render:()=>e("div",{style:{display:"flex",flexDirection:"column",gap:"40px",padding:"20px",background:"#f8fafc"},children:[e("div",{children:[e("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"🎨 Custom Styled Card"}),e(t,{values:{html:`
              <div style="
                background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            ...
            `},mode:"web"})]}),e("div",{children:[e("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"📊 Progress Indicators"}),e(t,{values:{html:`
            ...
            `},mode:"web"})]}),e("div",{children:[e("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"🌟 Statistics Grid"}),e(t,{values:{html:`
            ...
            `},mode:"web"})]}),e("div",{children:[e("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"📝 Testimonial"}),e(t,{values:{html:`
            ...
            `},mode:"web"})]}),e("div",{children:[e("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"📧 Email-Safe HTML"}),e("div",{style:{backgroundColor:"#ffffff",padding:"20px",borderRadius:"8px"},children:e(t,{values:{html:`
