import{u as e}from"./compat.module-fI-V5Ght.js";import{T as t}from"./Text-JKKR9X2i.js";import"./iframe-BgLncab-.js";import"./preload-helper-PPVm8Dsz.js";import"./create-component-BWEBAc00.js";const S={title:"Components/Text",component:t,parameters:{layout:"centered",docs:{description:{component:`
# 📝 Text Component
...
}`}}},mode:{control:{type:"select"},options:["web","email","document"],description:"**Rendering Mode** - Controls output format and typography optimizations",table:{defaultValue:{summary:"web"},type:{summary:"RenderMode"}}}},tags:["autodocs"]},n={render:()=>e(t,{children:"This is the simplest way to use Text - just pass text as children!"}),parameters:{docs:{description:{story:`
...
- When you want default styling
        `}}}},i={render:()=>e(t,{color:"#374151",fontSize:"16px",lineHeight:"1.6",fontWeight:"500",textAlign:"center",containerPadding:"20px",children:"This text uses semantic props for styling! It's centered with custom colors, sizing, and spacing."}),parameters:{docs:{description:{story:`
...
- \`containerPadding\`: Padding around text
        `}}}},o={args:{values:{text:"This is default text using schema-driven defaults"},mode:"web"},parameters:{docs:{description:{story:"**Default Text (Values API)** - Uses the values object for full control. This approach gives you access to all Unlayer configuration options."}}}},a={args:{values:{text:"This is body text that demonstrates how the Text component renders standard content with beautiful typography. It's perfect for paragraphs, descriptions, and general content.",fontSize:"16px",lineHeight:"1.6",color:"#374151",fontFamily:{label:"Inter",value:"Inter, -apple-system, BlinkMacSystemFont, sans-serif"},textAlign:"left"},mode:"web"}},r={args:{values:{text:"Image caption or small descriptive text that provides additional context.",fontSize:"14px",lineHeight:"1.4",color:"#6b7280",fontFamily:{label:"Inter",value:"Inter, -apple-system, BlinkMacSystemFont, sans-serif"},textAlign:"center",fontStyle:"italic"},mode:"web"}},s={args:{values:{text:"This text stands out with beautiful highlighting and emphasis to draw attention to important information.",fontSize:"18px",lineHeight:"1.5",color:"#1f2937",backgroundColor:"#fef3c7",padding:"16px 20px",borderRadius:"8px",fontWeight:"500",textAlign:"center"},mode:"web"}},l={args:{values:{text:"Visit our website to learn more about our services and solutions.",fontSize:"16px",lineHeight:"1.6",color:"#374151",linkStyle:{inherit:!1,linkColor:"#2563eb",linkHoverColor:"#1d4ed8",linkUnderline:!0,linkHoverUnderline:!0},textAlign:"left"},mode:"web"}},c={args:{values:{text:"Our enterprise solution provides comprehensive tools for modern businesses to scale efficiently and securely.",fontSize:"16px",lineHeight:"1.7",color:"#1f2937",fontFamily:{label:"Source Sans Pro",value:"Source Sans Pro, Arial, sans-serif"},textAlign:"justify",letterSpacing:"0.025em"},mode:"web"}},d={args:{values:{text:"Mobile-optimized text that's easy to read on smaller screens with appropriate sizing and spacing.",fontSize:"18px",lineHeight:"1.6",color:"#111827",fontFamily:{label:"System UI",value:"-apple-system, BlinkMacSystemFont, sans-serif"},textAlign:"left",padding:"12px 0"},mode:"web"}},p={args:{values:{text:"This email-safe text uses web-safe fonts and styling that renders consistently across all email clients.",fontSize:"16px",lineHeight:"1.5",color:"#333333",fontFamily:{label:"Arial",value:"Arial, Helvetica, sans-serif"},textAlign:"left"},mode:"email"}},g={args:{values:{text:"Colorful text that demonstrates the vibrant possibilities with custom color schemes.",fontSize:"20px",lineHeight:"1.4",color:"#7c3aed",fontWeight:"600",textAlign:"center",textTransform:"uppercase",letterSpacing:"0.05em"},mode:"web"}},x={render:()=>e("div",{style:{display:"flex",flexDirection:"column",gap:"32px",padding:"40px",background:"#ffffff",maxWidth:"800px"},children:[e("div",{children:[e("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"24px",fontWeight:"700"},children:"📝 Content Typography"}),e("div",{style:{display:"flex",flexDirection:"column",gap:"24px"},children:[e(t,{values:{text:"Large heading text that captures attention and establishes hierarchy.",fontSize:"24px",lineHeight:"1.3",color:"#111827",fontWeight:"700",textAlign:"left"},mode:"web"}),e(t,{values:{text:"This is body text that provides detailed information with comfortable reading typography. It demonstrates how the Text component handles longer content with proper line height and spacing.",fontSize:"16px",lineHeight:"1.6",color:"#374151",textAlign:"left"},mode:"web"}),e(t,{values:{text:"Small caption text for additional details and metadata.",fontSize:"14px",lineHeight:"1.4",color:"#6b7280",textAlign:"left",fontStyle:"italic"},mode:"web"})]})]}),e("div",{children:[e("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"24px",fontWeight:"700"},children:"🎨 Styled Text"}),e("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:[e(t,{values:{text:"Highlighted important information with background color",fontSize:"16px",color:"#92400e",backgroundColor:"#fef3c7",padding:"12px 16px",borderRadius:"6px",textAlign:"center",fontWeight:"500"},mode:"web"}),e(t,{values:{text:"UPPERCASE ACCENT TEXT WITH LETTER SPACING",fontSize:"14px",color:"#7c3aed",fontWeight:"600",textTransform:"uppercase",letterSpacing:"0.1em",textAlign:"center"},mode:"web"}),e(t,{values:{text:"Professional text with custom font family and precise spacing",fontSize:"16px",color:"#1f2937",lineHeight:"1.7",fontFamily:{label:"Source Sans Pro",value:"Source Sans Pro, Arial, sans-serif"},letterSpacing:"0.025em",textAlign:"left"},mode:"web"})]})]}),e("div",{children:[e("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"24px",fontWeight:"700"},children:"🌈 Color Variations"}),e("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(200px, 1fr))",gap:"16px"},children:[e(t,{values:{text:"Primary Blue Text",fontSize:"16px",color:"#2563eb",fontWeight:"600",textAlign:"center"},mode:"web"}),e(t,{values:{text:"Success Green Text",fontSize:"16px",color:"#059669",fontWeight:"600",textAlign:"center"},mode:"web"}),e(t,{values:{text:"Warning Orange Text",fontSize:"16px",color:"#d97706",fontWeight:"600",textAlign:"center"},mode:"web"}),e(t,{values:{text:"Danger Red Text",fontSize:"16px",color:"#dc2626",fontWeight:"600",textAlign:"center"},mode:"web"})]})]}),e("div",{children:[e("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"24px",fontWeight:"700"},children:"📧 Email-Safe Typography"}),e("div",{style:{backgroundColor:"#f9fafb",padding:"24px",borderRadius:"8px"},children:e(t,{values:{text:"This text uses email-safe fonts and styling that renders consistently across Gmail, Outlook, Apple Mail, and other email clients.",fontSize:"16px",lineHeight:"1.5",color:"#333333",fontFamily:{label:"Arial",value:"Arial, Helvetica, sans-serif"},textAlign:"left"},mode:"email"})})]})]})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => <Text>
...
}`,...x.parameters?.docs?.source}}};const b=["SimpleText","WithSemanticProps","Default","BodyText","CaptionText","HighlightedText","LinkedText","ProfessionalText","MobileText","EmailText","ColorfulText","TextShowcase"];export{a as BodyText,r as CaptionText,g as ColorfulText,o as Default,p as EmailText,s as HighlightedText,l as LinkedText,d as MobileText,c as ProfessionalText,n as SimpleText,x as TextShowcase,i as WithSemanticProps,b as __namedExportsOrder,S as default};
