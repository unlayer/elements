import{u as n}from"./compat.module-fI-V5Ght.js";import{c as w,Y as S,m as y,C as e}from"./create-component-BWEBAc00.js";import{B as f,R as t,C as a}from"./Column-DSNide1u.js";import{H as m}from"./Heading-Cth81_4X.js";import{T as o}from"./Text-JKKR9X2i.js";import{U as g}from"./UnlayerProvider-D-GS-MYN.js";import"./iframe-BgLncab-.js";import"./preload-helper-PPVm8Dsz.js";const A={items:[]},u={align:"center",menu:A,layout:"horizontal",separator:"|"},c=w({name:"Menu",defaultValues:u,propMapper:x=>{const{items:h,...v}=x;if(Array.isArray(h)){const k=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(v,u,"Menu");return b.menu={items:k},b}return y(x,u,"Menu")},displayName:"Menu",exporters:S}),U={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
# Menu Component
...
<Menu
  ...
  linkColor="#2563eb"
/>
\`\`\``}}}},i={args:{values:{menu:{items:[{text:"Home",link:{name:"web",values:{href:"#home",target:"_blank"}}},{text:"About",link:{name:"web",values:{href:"#about",target:"_blank"}}},{text:"Services",link:{name:"web",values:{href:"#services",target:"_blank"}}},{text:"Contact",link:{name:"web",values:{href:"#contact",target:"_blank"}}}]},layout:"horizontal",align:"center",separator:"|",padding:"10px 16px",fontSize:"14px",fontWeight:"normal",linkColor:"#2563eb",textColor:"#374151",letterSpacing:"0px"}},parameters:{docs:{description:{story:"**Full Control** — use the `values` prop for complete exporter-format control."}}}},l={render:()=>n(g,{config:{mode:"email"},children:n(f,{backgroundColor:"#f4f4f5",contentAlign:"center",contentWidth:"600px",fontFamily:{label:"Arial",value:"Arial, Helvetica, sans-serif"},textColor:"#1f2937",children:[n(t,{layout:e.OneColumn,backgroundColor:"#ffffff",padding:"32px 24px 16px 24px",children:n(a,{children:n(m,{values:{text:"Acme Inc.",headingType:"h2",fontSize:"28px",fontWeight:"700",color:"#111827",textAlign:"center",fontFamily:"Arial, Helvetica, sans-serif",lineHeight:"110%",containerPadding:"0 0 4px 0"}})})}),n(t,{layout:e.OneColumn,backgroundColor:"#ffffff",padding:"0px 24px 24px 24px",children:n(a,{children:n(c,{values:{menu:{items:[{text:"Products",link:{name:"web",values:{href:"https://example.com/products",target:"_blank"}}},{text:"Pricing",link:{name:"web",values:{href:"https://example.com/pricing",target:"_blank"}}},{text:"Blog",link:{name:"web",values:{href:"https://example.com/blog",target:"_blank"}}},{text:"Support",link:{name:"web",values:{href:"https://example.com/support",target:"_blank"}}}]},layout:"horizontal",align:"center",separator:"|",padding:"8px 14px",fontSize:"14px",fontWeight:"normal",linkColor:"#4b5563",textColor:"#9ca3af",letterSpacing:"0px",fontFamily:{label:"Arial",value:"Arial, Helvetica, sans-serif"},containerPadding:"0"}})})}),n(t,{layout:e.OneColumn,backgroundColor:"#2563eb",padding:"0px",children:n(a,{padding:"2px",children:n(o,{values:{text:"&nbsp;",fontSize:"1px",lineHeight:"1px",containerPadding:"0"}})})}),n(t,{layout:e.OneColumn,backgroundColor:"#ffffff",padding:"40px 32px",children:n(a,{children:[n(m,{values:{text:"Your weekly digest is here",headingType:"h1",fontSize:"24px",fontWeight:"700",color:"#111827",textAlign:"left",fontFamily:"Arial, Helvetica, sans-serif",lineHeight:"130%",containerPadding:"0 0 16px 0"}}),n(o,{values:{text:"Here is a summary of what happened this week across your projects and teams. Click on any section to dive deeper.",fontSize:"15px",color:"#4b5563",textAlign:"left",lineHeight:"160%",fontFamily:"Arial, Helvetica, sans-serif",containerPadding:"0"}})]})})]})}),parameters:{layout:"fullscreen",docs:{description:{story:`
...
\`\`\`
        `}}}},s={render:()=>n(g,{config:{mode:"email"},children:n(f,{backgroundColor:"#f9fafb",contentAlign:"center",contentWidth:"600px",fontFamily:{label:"Arial",value:"Arial, Helvetica, sans-serif"},textColor:"#6b7280",children:[n(t,{layout:e.OneColumn,backgroundColor:"#e5e7eb",padding:"0px",children:n(a,{padding:"1px",children:n(o,{values:{text:"&nbsp;",fontSize:"1px",lineHeight:"1px",containerPadding:"0"}})})}),n(t,{layout:e.OneColumn,backgroundColor:"#f9fafb",padding:"28px 24px 12px 24px",children:n(a,{children:n(o,{values:{text:"Acme Inc. | 123 Main Street, San Francisco, CA 94105",fontSize:"12px",color:"#9ca3af",textAlign:"center",lineHeight:"150%",fontFamily:"Arial, Helvetica, sans-serif",containerPadding:"0 0 12px 0"}})})}),n(t,{layout:e.OneColumn,backgroundColor:"#f9fafb",padding:"0px 24px 28px 24px",children:n(a,{children:n(c,{values:{menu:{items:[{text:"View Online",link:{name:"web",values:{href:"https://example.com/view",target:"_blank"}}},{text:"Unsubscribe",link:{name:"web",values:{href:"https://example.com/unsubscribe",target:"_blank"}}},{text:"Privacy Policy",link:{name:"web",values:{href:"https://example.com/privacy",target:"_blank"}}},{text:"Terms",link:{name:"web",values:{href:"https://example.com/terms",target:"_blank"}}}]},layout:"horizontal",align:"center",separator:"-",padding:"6px 10px",fontSize:"12px",fontWeight:"normal",linkColor:"#6b7280",textColor:"#d1d5db",letterSpacing:"0px",fontFamily:{label:"Arial",value:"Arial, Helvetica, sans-serif"},containerPadding:"0"}})})})]})}),parameters:{layout:"fullscreen",docs:{description:{story:`
**Email Footer Links**
...
/>
\`\`\`
        `}}}},p={render:()=>n(g,{config:{mode:"web"},children:n(f,{backgroundColor:"#0f172a",contentAlign:"center",contentWidth:"800px",fontFamily:{label:"Inter",value:"Inter, system-ui, -apple-system, sans-serif"},textColor:"#ffffff",children:[n(t,{layout:e.OneColumn,backgroundColor:"#1e293b",padding:"20px 32px",children:n(a,{children:n(c,{values:{menu:{items:[{text:"DASHBOARD",link:{name:"web",values:{href:"/dashboard",target:"_self"}}},{text:"ANALYTICS",link:{name:"web",values:{href:"/analytics",target:"_self"}}},{text:"TEMPLATES",link:{name:"web",values:{href:"/templates",target:"_self"}}},{text:"INTEGRATIONS",link:{name:"web",values:{href:"/integrations",target:"_self"}}},{text:"SETTINGS",link:{name:"web",values:{href:"/settings",target:"_self"}}}]},layout:"horizontal",align:"center",separator:"",padding:"10px 20px",fontSize:"12px",fontWeight:"700",linkColor:"#94a3b8",textColor:"#475569",letterSpacing:"1.5px",fontFamily:{label:"Inter",value:"Inter, system-ui, -apple-system, sans-serif"},containerPadding:"0"}})})}),n(t,{layout:e.OneColumn,backgroundColor:"#0f172a",padding:"64px 40px 48px 40px",children:n(a,{children:[n(m,{values:{text:"Ship faster with Unlayer",headingType:"h1",fontSize:"44px",fontWeight:"800",color:"#f8fafc",textAlign:"center",fontFamily:"Inter, system-ui, sans-serif",lineHeight:"110%",containerPadding:"0 0 20px 0"}}),n(o,{values:{text:"Drag-and-drop email and page builders you can embed in your SaaS in minutes, not months.",fontSize:"18px",color:"#94a3b8",textAlign:"center",lineHeight:"160%",fontFamily:"Inter, system-ui, sans-serif",containerPadding:"0"}})]})})]})}),parameters:{layout:"fullscreen",docs:{description:{story:`
