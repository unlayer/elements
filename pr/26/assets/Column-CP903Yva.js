import{j as h}from"./jsx-runtime-BmFXuIVH.js";import{R as C}from"./iframe-c9E3eP2P.js";import{w as q,x as M,v as P,i as D,m as N,J as L,U as V,l as B,o as I,q as $,K as b}from"./create-component-CUh8K7cK.js";const H=q,{popupPosition:ie,popupDisplayDelay:pe,popupWidth:le,popupHeight:me,popupBackgroundColor:ce,popupBackgroundImage:de,popupOverlay_backgroundColor:ue,popupCloseButton_position:ye,popupCloseButton_backgroundColor:fe,popupCloseButton_iconColor:we,popupCloseButton_borderRadius:_e,popupCloseButton_margin:ge,popupCloseButton_action:Ce,...k}=H,j=k,F={...M},O={...P},Y=F,K=j;function G(r){if(r.length===0)return[];const t=r.reduce((o,n)=>o+n,0);return t<=0?[]:r.map(o=>{const n=Math.round(o/t*100*100)/100,a=`${n}`.replace(/\./g,"p");return{value:n,className:a}})}function W(r,t,o=600,n=620){const a=G(r);if(t==="email"){const e=`@media only screen and (min-width: ${o+20}px)`,l=`@media only screen and (max-width: ${o+20}px)`;return`
${e} {
