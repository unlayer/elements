import{j as e}from"./jsx-runtime-C929VLGc.js";import{c as w,a as S,m as y,E as A,C as n}from"./create-component-CGwMGXqj.js";import{B as f}from"./Body-W489WbD1.js";import{R as t,C as a}from"./Column-LlN7FhGO.js";import{H as u}from"./Heading-DP3ymMWm.js";import{P as o}from"./Paragraph-DMTCPHRz.js";import{U as x}from"./UnlayerProvider-J4-E6dXc.js";import"./iframe-Emy4OqHI.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),W={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
