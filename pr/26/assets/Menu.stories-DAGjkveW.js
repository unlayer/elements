import{j as e}from"./jsx-runtime-BmFXuIVH.js";import{c as w,a as S,m as y,E as A,C as n}from"./create-component-CUh8K7cK.js";import{B as f}from"./Body-DhpGO5Qj.js";import{R as t,C as a}from"./Column-CP903Yva.js";import{H as u}from"./Heading-DH7I33U5.js";import{P as o}from"./Paragraph-sIqeDZtr.js";import{U as x}from"./UnlayerProvider-HD9UJTG9.js";import"./iframe-c9E3eP2P.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),W={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
