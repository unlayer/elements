import{j as t}from"./jsx-runtime-BeM-6lTP.js";import{r as f}from"./register-tool-CLG-kbV4.js";import{E as d}from"./Email-NRC0rKW1.js";import{R as l,C as s}from"./Column-Bcibkpme.js";import{H as m}from"./Heading-Kvn98aRL.js";import{P as x}from"./Paragraph-CwRvgvF3.js";import"./iframe-M4Vf4_JS.js";import"./preload-helper-PPVm8Dsz.js";import"./create-component-C_i99gso.js";import"./Body-CApRaWj0.js";const h={name:"countdown",options:{timer:{title:"Timer",options:{headline:{label:"Headline",defaultValue:"Offer ends in",widget:"text"},days:{label:"Days",defaultValue:"02",widget:"text"},hours:{label:"Hours",defaultValue:"11",widget:"text"},minutes:{label:"Minutes",defaultValue:"45",widget:"text"},accent:{label:"Accent",defaultValue:"#e11d48",widget:"color_picker"}}}},values:{},renderer:{exporters:{web:e=>{const n=(c,p)=>`<div style="background:#111827;border:1px solid #1f2937;border-radius:12px;padding:14px 0;width:76px;text-align:center;">
