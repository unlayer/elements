import{j as t}from"./jsx-runtime-DewU83Ee.js";import{r as f}from"./register-tool-4Gz5Ex_z.js";import{E as d}from"./Email-BHia42xL.js";import{R as l,C as s}from"./Column-Blpb7ruE.js";import{H as m}from"./Heading-Dm6WrPzo.js";import{P as x}from"./Paragraph-B-oelFtG.js";import"./iframe-B4v-Aris.js";import"./preload-helper-PPVm8Dsz.js";import"./create-component-CwFylwyb.js";import"./Body-DpN1yf8J.js";const h={name:"countdown",options:{timer:{title:"Timer",options:{headline:{label:"Headline",defaultValue:"Offer ends in",widget:"text"},days:{label:"Days",defaultValue:"02",widget:"text"},hours:{label:"Hours",defaultValue:"11",widget:"text"},minutes:{label:"Minutes",defaultValue:"45",widget:"text"},accent:{label:"Accent",defaultValue:"#e11d48",widget:"color_picker"}}}},values:{},renderer:{exporters:{web:e=>{const n=(c,p)=>`<div style="background:#111827;border:1px solid #1f2937;border-radius:12px;padding:14px 0;width:76px;text-align:center;">
