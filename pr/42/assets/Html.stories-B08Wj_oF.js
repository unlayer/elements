import{j as e}from"./jsx-runtime-BeM-6lTP.js";import{R as h}from"./iframe-M4Vf4_JS.js";import{c as u,d as y,m as v,k as w}from"./create-component-C_i99gso.js";import"./preload-helper-PPVm8Dsz.js";const f={...y,html:""},n=u({name:"Html",defaultValues:f,propMapper:b=>{const{children:g,...m}=b,l=v(m,f,"Html");if(g!==void 0&&!l.html){const x=h.Children.toArray(g);x.every(c=>typeof c=="string"||typeof c=="number")?l.html=x.join(""):console.warn('[Unlayer] <Html> children must be a raw HTML string — React elements are ignored. Pass the markup as a string child or via the `html` prop: <Html html="<div>…</div>" />.')}return l},displayName:"Html",exporters:w}),T={title:"Components/Html",component:n,parameters:{layout:"centered",docs:{description:{component:`
...
- Advanced content blocks
        `}}},argTypes:{mode:{control:{type:"select"},options:["web","email","document"],description:"**Rendering Mode** - Controls output format and html optimizations",table:{defaultValue:{summary:"web"},type:{summary:"RenderMode"}}}},tags:["autodocs"]},t={args:{mode:"web"}},i={args:{html:`
        <div style="
...
}`,...p.parameters?.docs?.source}}};const j=["Default","StyledCard","ProgressBars","CallToAction","TestimonialCard","Statistics","EmailHtml","HtmlShowcase"];export{r as CallToAction,t as Default,s as EmailHtml,p as HtmlShowcase,o as ProgressBars,d as Statistics,i as StyledCard,a as TestimonialCard,j as __namedExportsOrder,T as default};
