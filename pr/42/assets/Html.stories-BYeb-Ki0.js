import{j as e}from"./jsx-runtime-DVFAqOo8.js";import{R as h}from"./iframe-D6WVpXXw.js";import{c as u,d as y,m as v,k as w}from"./create-component-BG9UH6gc.js";import"./preload-helper-PPVm8Dsz.js";const f={...y,html:""},n=u({name:"Html",defaultValues:f,propMapper:b=>{const{children:x,...m}=b,l=v(m,f,"Html");if(x!==void 0&&!l.html){const g=h.Children.toArray(x);g.every(c=>typeof c=="string"||typeof c=="number")?l.html=g.join(""):console.warn('[Unlayer] <Html> children must be a raw HTML string — React elements are ignored. Pass the markup as a string child or via the `html` prop: <Html html="<div>…</div>" />.')}return l},displayName:"Html",exporters:w}),T={title:"Components/Html",component:n,parameters:{layout:"centered",docs:{description:{component:`
...
- Advanced content blocks
        `}}},argTypes:{mode:{control:{type:"select"},options:["web","email","document"],description:"**Rendering Mode** - Controls output format and html optimizations",table:{defaultValue:{summary:"web"},type:{summary:"RenderMode"}}}},tags:["autodocs"]},t={args:{html:`<div style="padding: 24px; border: 1px solid #e5e7eb; border-radius: 8px; font-family: Arial, sans-serif; color: #1f2937; max-width: 400px; margin: 0 auto; text-align: center;">
      ...
      `,mode:"email"}},p={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"40px",padding:"20px",background:"#f8fafc"},children:[e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Custom Styled Card"}),e.jsx(n,{html:`
              <div style="
                background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            ...
            `,mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Progress Indicators"}),e.jsx(n,{html:`
            ...
            `,mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Statistics Grid"}),e.jsx(n,{html:`
            ...
            `,mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Testimonial"}),e.jsx(n,{html:`
            ...
            `,mode:"web"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 20px",color:"#1f2937",fontSize:"20px",fontWeight:"700"},children:"Email-Safe HTML"}),e.jsx("div",{style:{backgroundColor:"#ffffff",padding:"20px",borderRadius:"8px"},children:e.jsx(n,{html:`
              ...
              `,mode:"email"})})]})]})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...p.parameters?.docs?.source}}};const H=["Default","StyledCard","ProgressBars","CallToAction","TestimonialCard","Statistics","EmailHtml","HtmlShowcase"];export{r as CallToAction,t as Default,s as EmailHtml,p as HtmlShowcase,o as ProgressBars,d as Statistics,i as StyledCard,a as TestimonialCard,H as __namedExportsOrder,T as default};
