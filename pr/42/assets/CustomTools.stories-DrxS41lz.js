import{j as t}from"./jsx-runtime-DVFAqOo8.js";import{r as f}from"./register-tool-CdFs1sDQ.js";import{E as d}from"./Email-CoyQs3B6.js";import{R as l,C as s}from"./Column-uWZfzNUv.js";import{H as m}from"./Heading-DK3O1MA9.js";import{P as x}from"./Paragraph-AbI-4eQp.js";import"./iframe-D6WVpXXw.js";import"./preload-helper-PPVm8Dsz.js";import"./create-component-BG9UH6gc.js";import"./Body-CQzvqPlz.js";const h={name:"countdown",options:{timer:{title:"Timer",options:{headline:{label:"Headline",defaultValue:"Offer ends in",widget:"text"},days:{label:"Days",defaultValue:"02",widget:"text"},hours:{label:"Hours",defaultValue:"11",widget:"text"},minutes:{label:"Minutes",defaultValue:"45",widget:"text"},accent:{label:"Accent",defaultValue:"#e11d48",widget:"color_picker"}}}},values:{},renderer:{exporters:{web:e=>{const n=(c,p)=>`<div style="background:#111827;border:1px solid #1f2937;border-radius:12px;padding:14px 0;width:76px;text-align:center;">
...
}`,...r.parameters?.docs?.source},description:{story:"Custom tools compose with built-ins inside a full design.",...r.parameters?.docs?.description}}};const j=["CountdownTool","CountdownCustomized","ProductCardTool","InsideAFullDesign"];export{a as CountdownCustomized,o as CountdownTool,r as InsideAFullDesign,i as ProductCardTool,j as __namedExportsOrder,E as default};
