import{j as e}from"./jsx-runtime-DewU83Ee.js";import{R as h}from"./iframe-B4v-Aris.js";import{c as u,d as y,m as v,k as w}from"./create-component-CwFylwyb.js";import"./preload-helper-PPVm8Dsz.js";const f={...y,html:""},n=u({name:"Html",defaultValues:f,propMapper:b=>{const{children:x,...m}=b,l=v(m,f,"Html");if(x!==void 0&&!l.html){const g=h.Children.toArray(x);g.every(c=>typeof c=="string"||typeof c=="number")?l.html=g.join(""):console.warn('[Unlayer] <Html> children must be a raw HTML string — React elements are ignored. Pass the markup as a string child or via the `html` prop: <Html html="<div>…</div>" />.')}return l},displayName:"Html",exporters:w}),T={title:"Components/Html",component:n,parameters:{layout:"centered",docs:{description:{component:`
