import{j as h}from"./jsx-runtime-StO-PRSP.js";import{R as C}from"./iframe-BDBMScOb.js";import{O as q,F as P,B as A,v as B,m as v,J as $,U as M,Z as b}from"./create-component-CilbWBRF.js";const D=q,{popupPosition:ee,popupDisplayDelay:oe,popupWidth:ne,popupHeight:te,popupBackgroundColor:re,popupBackgroundImage:ae,popupOverlay_backgroundColor:se,popupCloseButton_position:ie,popupCloseButton_backgroundColor:pe,popupCloseButton_iconColor:le,popupCloseButton_borderRadius:me,popupCloseButton_margin:ce,popupCloseButton_action:de,...H}=D,V=H,k={...A},I={...P},j=k,F=V;function O(r){if(r.length===0)return[];const t=r.reduce((n,o)=>n+o,0);return t<=0?[]:r.map(n=>{const o=Math.round(n/t*100*100)/100,a=`${o}`.replace(/\./g,"p");return{value:o,className:a}})}function W(r,t,n=600,o=620){const a=O(r);if(t==="email"){const e=`@media only screen and (min-width: ${n+20}px)`,l=`@media only screen and (max-width: ${n+20}px)`;return`
${e} {
