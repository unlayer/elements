import{j as t}from"./jsx-runtime-DVcQg-IR.js";import{r as f}from"./register-tool-CypjrbL_.js";import{E as d}from"./Email-D9DeiQ4W.js";import{R as l,C as s}from"./Column-LkkjUZg5.js";import{H as m}from"./Heading-Dw7M7Lgh.js";import{P as x}from"./Paragraph-BmEwrx4i.js";import"./iframe-VMmuojDn.js";import"./preload-helper-PPVm8Dsz.js";import"./create-component-C6knhKnS.js";import"./Body-CvUVN-rp.js";const h={name:"countdown",options:{timer:{title:"Timer",options:{headline:{label:"Headline",defaultValue:"Offer ends in",widget:"text"},days:{label:"Days",defaultValue:"02",widget:"text"},hours:{label:"Hours",defaultValue:"11",widget:"text"},minutes:{label:"Minutes",defaultValue:"45",widget:"text"},accent:{label:"Accent",defaultValue:"#e11d48",widget:"color_picker"}}}},values:{},renderer:{exporters:{web:e=>{const n=(c,p)=>`<div style="background:#111827;border:1px solid #1f2937;border-radius:12px;padding:14px 0;width:76px;text-align:center;">
