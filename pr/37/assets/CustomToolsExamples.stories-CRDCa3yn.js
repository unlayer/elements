import{j as o}from"./jsx-runtime-DVcQg-IR.js";import{R}from"./iframe-VMmuojDn.js";import{r as V}from"./register-tool-CypjrbL_.js";import{m as D,a as B,b as F,U as ee,D as J,s as te}from"./create-component-C6knhKnS.js";import{B as N,a as O,b as Q,R as h,C as b}from"./Column-LkkjUZg5.js";import{E as L}from"./Email-D9DeiQ4W.js";import{B as oe}from"./Body-CvUVN-rp.js";import{H as E}from"./Heading-Dw7M7Lgh.js";import"./preload-helper-PPVm8Dsz.js";function y(e){return o.jsx(oe,{...e,mode:"web"})}y.displayName="Page";y.__docgenInfo={description:`Page - Renders with div/flexbox for responsive web display.
...
\`\`\``,methods:[],displayName:"Page"};function S(e,t,n=0){return{...e,_meta:{htmlID:`u_content_${t.toLowerCase()}_${n+1}`,htmlClassNames:`u_content_${t.toLowerCase()}`,...e._meta||{}}}}function G(e){const t=e.type;return t?.displayName||t?.name}function z(e){const t=[];return R.Children.forEach(e,n=>{R.isValidElement(n)&&t.push(n)}),t}function M(e,t=[]){const n=new Set(["children","mode","className","style","index","colIndex","cells","bodyValues","rowValues","_config","config","previewText","layout","collection",...t]),r={};for(const[i,a]of Object.entries(e))!n.has(i)&&a!==void 0&&(r[i]=a);return r}function H(e,t){return e[t]=(e[t]||0)+1,e[t]}function I(e,t,n,r,i,a,l,s){if(!e)return;const d=[t,n,{displayMode:r,isViewer:!1,variant:null,type:"rows",headConfig:i}],c=e.css?.(...d);c&&a.push(c);const p=e.js?.(...d);p&&l.push(p);const u=e.tags?.(...d);u&&s.push(...u)}function ne(e,t,n,r,i,a,l,s){const c=e.type[ee];if(!c)return;const{name:p,defaultValues:u,propMapper:g}=c,{children:f,...m}=e.props,x=g({children:f,...m}),q=B(u,x),W=c.metaName??p.toLowerCase(),Z=H(i,`u_content_${W}`),K=S(q,W,Z-1),X=c.head??F[p];I(X,K,t,n,r,a,l,s)}function re(e,t,n,r,i,a,l,s,d){const c=M(e.props),p=D(c,Q,"Column"),u=H(a,"u_column"),g=S(B(Q,p),"column",u-1),f=F.Column;I(f,g,t,r,i,l,s,d);const m=z(e.props.children);for(const x of m)ne(x,t,r,i,a,l,s,d)}function ae(e,t,n,r,i,a,l,s){const d=M(e.props,["layout"]),c=D(d,O,"Row"),p=H(i,"u_row"),u=S(B(O,c),"row",p-1),g=F.Row;I(g,u,t,n,r,a,l,s);const f=z(e.props.children);for(const m of f)G(m)==="Column"&&re(m,t,u,n,r,i,a,l,s)}function ie(e,t){const{displayMode:n}=t,r={hasFeature:t.headConfig?.hasFeature??(()=>!1),getInitialValues:t.headConfig?.getInitialValues??(()=>({}))},i=[],a=[],l=[],s={},d=M(e.props),c=D(d,N,"Body"),p=S(B(N,c),"body",0),u=F.Body;I(u,p,p,n,r,i,a,l);const g=z(e.props.children);for(const m of g)G(m)==="Row"&&ae(m,p,n,r,s,i,a,l);const f=[...new Set(l.filter(Boolean))];return{css:i.filter(Boolean).join(`
...
<Email><Row><Column><QrCode width="35" /></Column></Row></Email>`),render:()=>o.jsx(w,{tree:o.jsx(L,{backgroundColor:"#ffffff",contentWidth:"600px",children:o.jsx(h,{children:o.jsxs(b,{children:[o.jsx(E,{fontSize:"18px",fontWeight:700,textAlign:"center",containerPadding:"26px 20px 2px",children:"Scan for your ticket"}),o.jsx(he,{width:"35",containerPadding:"8px 20px 30px"})]})})})})},A={parameters:C(`// The gallery original builds a Google Static Maps URL (needs an API
