import{j as h}from"./jsx-runtime-KBI_tWD0.js";import{R as g}from"./iframe-DTO4ORds.js";import{w as V,x as M,v as D,o as k,m as P,j as R,J as $,q as B,U as H,r as j,t as q,K as v}from"./create-component-CBbxHwtw.js";const F=V,{popupPosition:le,popupDisplayDelay:me,popupWidth:de,popupHeight:ue,popupBackgroundColor:ce,popupBackgroundImage:ye,popupOverlay_backgroundColor:fe,popupCloseButton_position:we,popupCloseButton_backgroundColor:ge,popupCloseButton_iconColor:Ce,popupCloseButton_borderRadius:_e,popupCloseButton_margin:xe,popupCloseButton_action:he,...W}=F,O=W,K={...M},Y={...D},G=K,J=O;function Q(r){if(r.length===0)return[];const n=r.reduce((o,e)=>o+e,0);return n<=0?[]:r.map(o=>{const e=Math.round(o/n*100*100)/100,a=`${e}`.replace(/\./g,"p");return{value:e,className:a}})}function z(r,n,o=600,e=480){const a=Q(r);if(n==="email"){const t=`@media only screen and (min-width: ${o+20}px)`,s=`@media only screen and (max-width: ${o+20}px)`;return`
${t} {
