import{j as u}from"./jsx-runtime-D8yg6K-Y.js";import{R as c}from"./iframe-CxGBnfVZ.js";import{D as b,i as R,m as T,R as _,j as h}from"./create-component-DdgUlgLx.js";import{B}from"./Column-DN5kSD-a.js";const C=B,p=150,x=[" ","‌","​","‍","‎","‏","\uFEFF"];function E(r){if(!r||r.trim().length===0)return"";const e=r.length>p?r.slice(0,p):r,t=Math.max(0,p-e.length);let i="";for(let n=0;n<t;n++)i+=x[n%x.length];return'<div data-skip-in-text="true" style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">'+e+i+"</div>"}function F(r,e,t,i){let n=r;if(t==="email"&&i){const s=E(i);s&&(n=s+r)}const a=h[t]||h.web;return(t==="document"?a(n,e,{type:""}):t==="email"?a(n,e,{bodyValues:e}):a(n,e,e)).replace("min-height: 100vh; ","").replace("min-height: 100vh;","")}const v=r=>{const{children:e,mode:t,className:i,style:n,index:a=0,config:f,previewText:s,...w}=r,y={...b,...f},g=t??y.mode??"web",P={...y,mode:g},d=R(C,T(w,C,"Body")),S={...d,_meta:{htmlID:`u_body_${a+1}`,htmlClassNames:"u_body",...d._meta||{}}};let l=e;e&&(l=c.Children.map(e,o=>c.isValidElement(o)?c.cloneElement(o,{_config:P,bodyValues:d}):o));let m="";if(l)try{m=_.renderToString(l)}catch(o){console.error("Body: Failed to render children:",o),m=""}try{const o=F(m,S,g,s);return u.jsx("div",{dangerouslySetInnerHTML:{__html:o},className:i,style:n})}catch(o){return console.error("Body rendering failed:",o),u.jsx("div",{className:i,style:n,children:e})}};v.displayName="Body";v.__docgenInfo={description:`Body - Universal Server/Client Component
