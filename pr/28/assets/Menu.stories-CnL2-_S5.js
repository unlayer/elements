import{j as e}from"./jsx-runtime-ByMePpIw.js";import{c as w,a as S,m as y,E as A,C as n}from"./create-component-XvZmf-2D.js";import{B as f}from"./Body-Deba6h8w.js";import{R as t,C as a}from"./Column-s-Pm_pUu.js";import{H as u}from"./Heading-Do4jee6J.js";import{P as o}from"./Paragraph-yP6Mco51.js";import{U as x}from"./UnlayerProvider-Bm50GxHH.js";import"./iframe-C6O3a5U-.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),W={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
