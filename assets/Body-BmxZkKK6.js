import{j as g}from"./jsx-runtime-Dihhmoxy.js";import{R as p}from"./iframe-eEQ_RtDy.js";import{D as P,i as R,m as T,R as _,j as h}from"./create-component-BYYd9Nb5.js";import{B}from"./Column-jhuMIigd.js";const C=B,c=150,x=[" ","‌","​","‍","‎","‏","\uFEFF"];function E(r){if(!r||r.trim().length===0)return"";const e=r.length>c?r.slice(0,c):r,t=Math.max(0,c-e.length);let i="";for(let n=0;n<t;n++)i+=x[n%x.length];return'<div data-skip-in-text="true" style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">'+e+i+"</div>"}function F(r,e,t,i){let n=r;if(t==="email"&&i){const s=E(i);s&&(n=s+r)}const a=h[t]||h.web;return(t==="document"?a(n,e,{type:""}):t==="email"?a(n,e,{bodyValues:e}):a(n,e,e)).replace("min-height: 100vh; ","").replace("min-height: 100vh;","")}const w=r=>{const{children:e,mode:t,className:i,style:n,index:a=0,config:f,previewText:s,...v}=r,u={...P,...f},y=t??u.mode??"web",b={...u,mode:y},d=R(C,T(v,C,"Body")),S={...d,_meta:{htmlID:`u_body_${a+1}`,htmlClassNames:"u_body",...d._meta||{}}};let m=e;e&&(m=p.Children.map(e,o=>p.isValidElement(o)?p.cloneElement(o,{_config:b,bodyValues:d}):o));let l="";if(m)try{l=_.renderToString(m)}catch(o){console.error("Body: Failed to render children:",o),l=""}try{const o=F(l,S,y,s);return g.jsx("div",{dangerouslySetInnerHTML:{__html:o},className:i,style:n})}catch(o){return console.error("Body rendering failed:",o),g.jsx("div",{className:i,style:n,children:e})}};w.displayName="Body";w.__docgenInfo={description:`Body - Universal Server/Client Component
