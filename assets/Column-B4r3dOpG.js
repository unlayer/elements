import{j as h}from"./jsx-runtime-_Vx7jW5k.js";import{R as g}from"./iframe-rRpdW3ub.js";import{t as V,v as H,w as M,y as D,m as A,q as N,G as $,z as k,A as B,U as j,V as q,N as v}from"./create-component-DZVYq3MR.js";const F=V,{popupPosition:pe,popupDisplayDelay:me,popupWidth:de,popupHeight:ue,popupBackgroundColor:ce,popupBackgroundImage:ye,popupOverlay_backgroundColor:fe,popupCloseButton_position:we,popupCloseButton_backgroundColor:ge,popupCloseButton_iconColor:Ce,popupCloseButton_borderRadius:_e,popupCloseButton_margin:xe,popupCloseButton_action:he,...W}=F,O=W,Y={...H},G={...M},K=Y,z=O;function Q(r){if(r.length===0)return[];const n=r.reduce((o,e)=>o+e,0);return n<=0?[]:r.map(o=>{const e=Math.round(o/n*100*100)/100,a=`${e}`.replace(/\./g,"p");return{value:e,className:a}})}function J(r,n,o=600,e=480){const a=Q(r);if(n==="email"){const t=`@media only screen and (min-width: ${o+20}px)`,s=`@media only screen and (max-width: ${o+20}px)`;return`
${t} {
