import{j as e}from"./jsx-runtime-CzIGWkPA.js";import{c as w,T as S,m as y,a as A,C as n}from"./create-component-D1HwNzNo.js";import{B as f}from"./Body-BDGu-KHR.js";import{R as t,C as a}from"./Column-CTl38d4d.js";import{H as u}from"./Heading-DVEYAPly.js";import{P as o}from"./Paragraph-DuFHqijc.js";import{U as x}from"./UnlayerProvider-D7yPmo7E.js";import"./iframe-C3uaC-jS.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),T={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
