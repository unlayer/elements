import{j as e}from"./jsx-runtime-StO-PRSP.js";import{c as w,T as S,m as y,a as A,C as n}from"./create-component-CilbWBRF.js";import{B as f}from"./Body-CCl-Uhcd.js";import{R as t,C as a}from"./Column-DeUkuVIL.js";import{H as u}from"./Heading-ZYPXS4Ot.js";import{P as o}from"./Paragraph-CWKwZHK9.js";import{U as x}from"./UnlayerProvider-DHiOYh0p.js";import"./iframe-BDBMScOb.js";import"./preload-helper-PPVm8Dsz.js";const m={...S},c=w({name:"Menu",defaultValues:m,propMapper:g=>{const{items:h,...k}=g;if(Array.isArray(h)){const v=h.map((d,C)=>({key:String(C+1),text:d.text,link:{name:"web",values:{href:d.href,target:d.target??"_blank"}}})),b=y(k,m,"Menu");return b.menu={items:v},b}return y(g,m,"Menu")},displayName:"Menu",exporters:A}),T={title:"Components/Menu",component:c,parameters:{layout:"centered",docs:{description:{component:`
...
}`,...p.parameters?.docs?.source}}};const W=["Default","FullPropsAPI","EmailHeader","FooterLinks","StyledNavigation"];export{r as Default,l as EmailHeader,s as FooterLinks,i as FullPropsAPI,p as StyledNavigation,W as __namedExportsOrder,T as default};
