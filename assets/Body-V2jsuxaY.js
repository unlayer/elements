import{j as h}from"./jsx-runtime-_Vx7jW5k.js";import{R as c}from"./iframe-rRpdW3ub.js";import{D as P,a as T,m as _,q as R,r as B,L as x}from"./create-component-DZVYq3MR.js";import{B as E}from"./Column-B4r3dOpG.js";const C=E,f=150,w=[" ","‌","​","‍","‎","‏","\uFEFF"];function F(r){if(!r||r.trim().length===0)return"";const e=r.length>f?r.slice(0,f):r,t=Math.max(0,f-e.length);let i="";for(let n=0;n<t;n++)i+=w[n%w.length];return'<div data-skip-in-text="true" style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">'+e+i+"</div>"}function q(r,e,t,i){let n=r;if(t==="email"&&i){const s=F(i);s&&(n=s+r)}const a=x[t]||x.web;return(t==="document"?a(n,e,{type:""}):t==="email"?a(n,e,{bodyValues:e}):a(n,e,e)).replace("min-height: 100vh; ","").replace("min-height: 100vh;","")}const v=r=>{const{children:e,mode:t,className:i,style:n,index:a=0,config:u,previewText:s,...b}=r,y={...P,...u},g=t??y.mode??"web",d={...y,mode:g};d.__ids={};const m=T(C,_(b,C,"Body")),S={...m,_meta:{htmlID:R(d,"u_body"),htmlClassNames:"u_body",...m._meta||{}}};let l=e;e&&(l=c.Children.map(e,o=>c.isValidElement(o)?c.cloneElement(o,{_config:d,bodyValues:m}):o));let p="";if(l)try{p=B.renderToString(l)}catch(o){console.error("Body: Failed to render children:",o),p=""}try{const o=q(p,S,g,s);return h.jsx("div",{dangerouslySetInnerHTML:{__html:o},className:i,style:n})}catch(o){return console.error("Body rendering failed:",o),h.jsx("div",{className:i,style:n,children:e})}};v.displayName="Body";v.__docgenInfo={description:`Body - Universal Server/Client Component
